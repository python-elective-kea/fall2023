Session 11 - Tips & Tricks 
==========================

Today we will work with a variaty of python concepts. 
We will look at **Context Managers** **shell commandline applikations**  
...
**Ex 1: Creating util tools for linux**
In this tutorial you will use what you already have learned previous. 
You will create a python program that when executed on a linux instance:
* installs git, vim, tree 
* clone this rempository xxx
* creats symlinks between all the files clones and the home folder
